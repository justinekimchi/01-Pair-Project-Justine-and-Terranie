...
v1 = Vehicle.create(make: "Ford", model: "F150", customer_id: c1, vehicle_type: "Truck")
v2 = Vehicle.create(make: "Ford", model: "Courier", customer_id: c1, vehicle_type: "Van")
v3 = Vehicle.create(make: "Nissan", model: "Sentra", customer_id: c2, vehicle_type: "Sedan")
v4 = Vehicle.create(make: "Chevrolet", model: "Corvette", customer_id: c3, vehicle_type: "Coupe")
v5 = Vehicle.create(make: "Toyota", model: "Tundra", customer_id: c4, vehicle_type: "Truck")
